                                              ...
                                              <tbody class="smaller2">
                                                 ...
                                                 @foreach($products as $purss)
                                                    ...
                                                    {{csrf_field()}}
                                                      ...
                                                      <td class="smaller4"><a href="../user/basket"><button type="submit" class="btn btn-danger btn-xs" > Delete </button> </a></td> 
                                                      <td class="smaller4"><a href=""> <button type="submit" class="btn btn-success btn-xs" > Order </button> </a></td>
                                                      

                                                       <td class="smaller5"><br /><a href="../user/basket"><button type="submit" class="btn btn-danger btn-xs" > Delete </button> </a></td> 
