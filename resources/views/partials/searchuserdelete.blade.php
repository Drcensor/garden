                     ...
                     <div class="containers">
                          ...
                          <div class="col-md-9 col-md-offset-3 "> 
                             <div class="panel panel-default">
              					  <div class="panel-heading bg-blue"><h1> Delete Accounts Information of Users</h1></div>

				  		 <div class="panel-body">                                
	                          <form class="example" method="get" action="/action_page_delete" style="max-width:300px">
               							       ...
               							       <table class="table table-striped">
					                                    ...
					                                    <tbody>
					                                       ...
					                                       @foreach($users as $user)
					                                        ...
					                                        <form method="post" action="user/adminDeleteUser">
					                                       ...
					                                       <tr class="<?=($c++%2==1) ? 'odd' : 'even' ?>">
					                                            ...
					                                            <td><input class="bigger3" type="text" name="lastname"  value="{{$user->lastname}}" /> </td>
					                                             ...
					                                             <td><input class="bigger1" type="text" name="admin"  value="{{$user->admin}} "/> </td>
					                    	                      <td><input class="bigger3" type="text" name="created_at"  value="{{$user->created_at}}" /> </td>
