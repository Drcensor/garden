				...
				{{csrf_field()}}
                    ...
                    <label>Plant Name &#58;      <select name="product_id">
                                                       <option value="1">Pointsettia  £5.99 </option>
                                                        ...
                                                        <option value="3">Pansy</option>
                                                        <option value="4">Geranium Rose</option>
                                                        <option value="5">Cyclamen</option>
                                                        <option value="6">Spider plant</option>
                                                        <option value="7">Orchid</option>
                                                        <option value="8">Rainbow Rose</option>
                                                  </select>
