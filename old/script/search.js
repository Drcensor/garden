...
title[1]="rose spider plant crocus "
desc[1]="Want best quality plants"
links[1]="products.html"
matched[1]=0

title[2]="form code email address"
desc[2]="Do you want to buy a plant"
links[2]="contact.html"
matched[2]=0
...
output.document.write('<title> GPP Nursery Search Results </title>');
output.document.write('<BODY bgcolor=#E0E0D6  text=#AE4747  link=#990099 vlink =#339966 >');
output.document.write('<center> <IMG WIDTH="80" HEIGHT="80" SRC="images/potted-plants.png"></center>');
output.document.write('<br>');
output.document.write('<center> <h1>GPP Nursery Search Results </h1></center>');    
